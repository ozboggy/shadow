...
click_data = st_folium(folium_map, height=400, key='home_map')
...
# Main loop-like rerun (Streamlit reruns script on interaction)
...
# Note: Add your alert scheduling/notifications below based on timing thresholds
