...
# OpenSky anonymous API endpoint generator
...
for ac in ac_list:
    ...
    layers.append(
        pdk.Layer(
            ...
            get_position="[lon, lat]", get_radius=100, get_color=[0,255,0], pickable=True
        )
    )
    # Shadows
