...
TARGET_LAT = -33.760342
TARGET_LON = 150.9715254
ALERT_RADIUS_METERS = 50
HOME_LAT = -33.760342
HOME_LON = 150.9715254
RADIUS_KM = 20
...
fmap = folium.Map(location=[-33.76025, 150.9711666], zoom_start=st.session_state.zoom)



marker_cluster = MarkerCluster().add_to(fmap)
folium.Marker((TARGET_LAT, TARGET_LON), icon=folium.Icon(color="red", icon="home", prefix="fa"), popup="Target").add_to(fmap)
